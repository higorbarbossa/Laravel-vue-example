...
return [
    ...
    */
    ...
    'unauthenticated' => 'Você não está autenticado para esta requisição.',
    'unauthorized' => 'Você não está autorizado para esta requisição.',
    'page_not_found' => 'A página requisitada não existe.',
    'relation_not_found' => 'A relação solicitada não existe.',
    'validation_failed' => 'Os dados fornecidos não foram aprovados na validação.',
